...
H_PER_1E9_TOK = {"s025m": 3.01, "s100m": 6.56, "s250m": 12.79, "s500m": 25.51}
...
def eval_lines(p: Profile) -> list[Line]:
    ...
    mins = {"s025m": 12, "s100m": 14, "s250m": 18, "s500m": 32}
    counts = branch_counts(p)
    out = []
    for s in p.students:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--profile", default="local5080", choices=["local5080", "local5080_fast", "smoke"])
    a = ap.parse_args()
